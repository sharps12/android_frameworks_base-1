...
public class NetworkTraffic extends TextView {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            Uri uri = Settings.CMREMIX.getUriFor(Settings.CMREMIX.NETWORK_TRAFFIC_STATE);
            resolver.registerContentObserver(uri, false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System
                    .getUriFor(Settings.CMREMIX.NETWORK_TRAFFIC_AUTOHIDE), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System
    ...
    private void updateSettings() {
        ...
        mAutoHide = Settings.CMREMIX.getIntForUser(resolver,
                Settings.CMREMIX.NETWORK_TRAFFIC_AUTOHIDE, 0,
                UserHandle.USER_CURRENT) == 1;

        mAutoHideThreshold = Settings.CMREMIX.getIntForUser(resolver,
