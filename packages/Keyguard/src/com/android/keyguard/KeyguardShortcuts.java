...
public class KeyguardShortcuts extends LinearLayout {
    ...
    private void createShortcuts() {
        ...
        boolean longpress = Settings.CMREMIX.getIntForUser(mContext.getContentResolver(),
                Settings.CMREMIX.LOCKSCREEN_SHORTCUTS_LONGPRESS, 1, UserHandle.USER_CURRENT) == 1;
